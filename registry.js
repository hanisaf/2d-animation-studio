...
const REGISTRY = {
  characters: ['jester_fester', 'princess_pearl'],
  locations: ['throne_room'],
  scenes: ['scene01_juggling', 'scene02_fired'],
  movie: ['scene01_juggling', 'scene02_fired'],        // running order for "Export movie" / node render.mjs --movie
};
